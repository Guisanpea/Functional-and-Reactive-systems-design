...
% https://english.stackexchange.com/questions/7642/what-is-the-difference-between-by-contrast-and-in-contrast
refer to the mathematical concept of a function. In mathematics, \enquote{a function \textit{f}
...
% cambia todos los entrecomillados que tengas tal como he hecho arriba 
...
languages, it could also be stated that \enquote{a pure function has no observable effect
...
% Te puede resultar interesante este artículo de Erik Meijer en el que
% argumenta que la programación funcional pura debe ser totalmente pura
% y que no cabe término medio:
% https://queue.acm.org/detail.cfm?id=2611829
%
% Erik ha denominado a este estilo de programación "Fundamentalist Functional Programming"
...
% parece que falta el listado typeclasssyntax.sc
