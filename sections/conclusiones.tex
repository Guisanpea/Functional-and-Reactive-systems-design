...
Esto es tan habitual que en los lenguajes imperativos existe un tipo, \textt{void}, que se utiliza
...
dichas funciones se centran en \texit{qué} valores deben devolver, y no en \texttt{cómo} 
